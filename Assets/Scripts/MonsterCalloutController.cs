    ...
    */
    ...
    public void PlayCalloutSound()
    {
        ...
        switch (GameplayController.Instance.CurrentLevel.monsterInputType)
        {
            ...
            case MonsterInputType.SoundLetterName:
                ...
                if (voice != null)
                {
                    AudioController.Instance.PlaySound(voice, 1f, monster.Pitch);
                }
                else
                {
    ...
    public void ShowNeededLetters()
    {
        ...
        switch (GameplayController.Instance.CurrentLevel.monsterInputType)
        {
            case MonsterInputType.Letter:
            case MonsterInputType.LetterName:
                Invoke("PlayCalloutSound", (GameplayController.Instance.gameTutorial == null) ? 0.5f : 1.0f);
    ...
    public void StartPlay(float t)
    {
        ...
        Timer.Instance.Create(new Timer.TimerCommand(GameplayController.Instance.ShowupBetweenLetterDelay, ShowupLetter));
    }

    void ShowupLetter(float t)
    {
        GameplayController.Instance.EndHandTutorial();
    ...
    bool IsGoodLetter(LetterController letter, int letterIndex)
    {
        ...
        switch (GameplayController.Instance.CurrentLevel.monsterInputType)
        {
            ...
            case MonsterInputType.SoundLetterName:
                ...
                if (letter.stone.value == GameplayController.Instance.CurrentSegment.MonsterRequiredLetters[0])
                { // correct letter
                    return true;
                }
                else
